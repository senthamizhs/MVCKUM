...
function LoadFlights(arg, obj1) {
    ...
    var CurrencyIcon = (assignedcurrency == "INR" ? "fa fa-inr" : "");
    try {
        if (arg != "" && arg != null) {
            ...
            if ($('#hdtxt_trip').val() == "O" || $('#hdtxt_trip').val() == "Y" || ($('#hdtxt_trip').val() == "M") && ($('body').data('segtype') == "D" || $('body').data('segtype') == "I")) { //Oneway or Roundtrip Special...
                ...
                paddingrigt = "unset";
                col_xs_4or_2 = "col-xs-3";
                col_xs_8or_10 = "col-xs-6";
            }
            else {
            ...
            if ($('#hdtxt_trip').val() == "Y" && $("#hdn_rtsplflag").val() == "N") {
                triptype_grp = "col-lg-5 col-xs-11";
            ...
            for (var sr = 0; sr < setofgroupedflight.length; sr++) {
                ...
                for (var len = 0; len < JsonObj.length; len++) {
                    ...
                    Refundtype = JSONdata["Refund"] == "TRUE" ? "R" : (JSONdata["Refund"] == "FALSE" ? "N" : "");
                    ...
                    if (JSONdata["Con"] == "Y") {
                        ...
                        if ($('#hdtxt_trip').val() == "O" || $('#hdtxt_trip').val() == "Y" || ($('#hdtxt_trip').val() == "M" && $('body').data('segtype') == "I")) {
                            MultiFlt += "onclick='javascript:GetRowIndexSelect_old(" + Ttotlen + ",\"singletripifflg\",\"tripfg\")'";
                        }
                        else {
                            MultiFlt += "onclick='javascript:GetRowIndexSelect_old(\"" + Ttotlen + "\",\"" + doubletripifflg + "\",\"" + JSONdata["bindside_6_arg"] + "\")' ";
                        }
                        MultiFlt += ">";
                        //con set #1
                    ...
                    if (segLen == 0) {
                        ...
                        MultiFlt += "<div class='col-md-10 col-xs-12 col0' style='border-right: 1px solid #f5f5f5;'>"//2
                    ...
                    if (MultiFlt == "") { /*****************without Details Flight Binding ***********/
                        ...
                        SAvail_build += "<div class='row row0 row-mob-0 rtripres'>"
                        //remove - style='padding-bottom: 2px;padding-top:10px;'
                        ...
                        if (($('#hdtxt_trip').val() == "R" || $('#hdtxt_trip').val() == "M") && $('body').data('segtype') == "D" && $("#hdn_AppHosting").val() == "BSA")
                            SAvail_build += "<div class='col-xs-9 col-sm-7 col15 col-mob-5 mobmrgbtn'>"
                        else
                            SAvail_build += "<div class=' " + col_xs_8or_10 + " col-sm-8 mobmrgbtn p-0'>"
                        //remove - col15 col-mob-5 add - p-0
                        SAvail_build += "<div class='row-mg-15minus'>"
                        SAvail_build += "<div class='col-xs-12 sectordetailscls pad-0-max'>"
                        SAvail_build += "<div class=''>"
                        ...
                        SAvail_build += "<div class='" + triptype_grp + " col-xs-12 col5' style='border-right: 1px solid #f5f5f5;'>" + availabilitybind + "</div>"
                        ...
                        if (JSONdata["nonstop"] != "" && JSONdata["nonstop"] != null) {
                            ...
                            SAvail_build += "<label class='mt-10 mb-0' style='text-align: center;color:red;font-size: 10px !important;max-width: 170px;text-overflow: ellipsis; width: 100%;white-space: nowrap;font-weight: 600;'>Via:" + JSONdata["nonstop"] + "</label>"
                        ...
                        if ($('#hdtxt_trip').val() == "O") {
                            if ($.isNumeric(JSONdata["Seats"]) && Number(JSONdata["Seats"]) < 3) {
                                seatconu += (JSONdata["Seats"] != "" && JSONdata["Seats"] != "0" ? "<span class='Seatsleft rush sbcss'><img src='" + strSeaticon + "'/><span class='Seatcnt'>" + ($.isNumeric(JSONdata["Seats"]) ? JSONdata["Seats"] : "0") + "</span><em class='hide'> Left</em></span>" : "<span class='Seatsleft rush'><span ></span></span>") // vis-hidn for Visibility hidden purpose (to zigzag order).. on 20170517... 0612
                            }
                            else {
                                seatconu += (JSONdata["Seats"] != "" && JSONdata["Seats"] != "0" ? "<span class='Seatsleft rush sbcss'><img src='" + strSeaticon + "'/><span class='Seatcnt'>" + ($.isNumeric(JSONdata["Seats"]) ? JSONdata["Seats"] : "0") + "</span><em class='hide'> Left</em></span>" : "<span class='Seatsleft rush'><span></span></span>") //0612
                            }
                        }
                        else {
                            if ($.isNumeric(JSONdata["Seats"]) && Number(JSONdata["Seats"]) < 3) {
                                ...
                                seatconu += (JSONdata["Seats"] != "" && JSONdata["Seats"] != "0" ? "<span class='Seatsleft rush sbcss'><img src='" + strSeaticon + "'/><span class='Seatcnt'>" + ($.isNumeric(JSONdata["Seats"]) ? JSONdata["Seats"] : "0") + "</span><em class='hide'> Left</em></span>" : "<span class='Seatsleft rush'><span></span></span>") //0221
                            }
                        }
                        ...
                        if (Checkbaggfunction(JSONdata["Bagg"]) == true) {
                            if ($("#hdn_AppHosting").val() == "BSA") {
                                baggagedetails_grp += "<span class='vcenter mob-bagg cls5 sbcss' data-toggle='tooltip' data-placement='top' title='Baggage: " + JSONdata["Bagg"].split('/')[0] + "'><img src='" + strImageUrl + '/' + $("#hdn_producttype").val() + "/" + "Bkg.png?V" + Versionflag + "' class='Availbkgimg' id='showbaggimg" + Ttotlen + "' /><span class='baggfontcolr' id='showbagg" + Ttotlen + "'>" + JSONdata["Bagg"].split('/')[0] + "</span></span>"
                            }
                            else {
                        ...
                        if (($('#hdtxt_trip').val() == "R" || $('#hdtxt_trip').val() == "M") && $('body').data('segtype') == "D" && $("#hdn_AppHosting").val() == "BSA")
                            SAvail_build += "<div class='col-sm-2 col-xs-12 farearea pad-0-max'>";
                        else                                              
                            SAvail_build += "<div class='col-sm-2 col-xs-3 farearea pad-0-max'>";

                        if ($("#hdn_producttype").val() == "RIYA" && JSONdata["Availagent"] != "") {
                            SAvail_build += "<span class='agntmark' id='agentid'>" + JSONdata["Availagent"] + "</span>";
                        }

                        if ($("#hdn_sessAgentLogin").val() == "Y" || $("#hdn_AppHosting").val() == "B2B") {
                        ...
                        //Fare Popup on 20170513 End...
                            ...
                            SAvail_build += "<div style='padding: 0px 0px 0px 0px !important; text-align:center;' id='GorssFareSpan2" + Ttotlen + "' data-WTMFare='" + con_WTMFare + "' data-grrfare='" + con_GFare + "'  data-netfare='" + Math.ceil(JSONdata["NETFare"]) + "' data-id='" + Ttotlen + "' class='liGrossfare_span a'>"
                            if ($("#HideComission").val() == "Y") {
                                SAvail_build += "<span class='flt-rgt pr-10'><span class='" + CurrencyIcon + " flt-lft font-13 pr-5'></span><span class='price' style='white-space: nowrap; chck5' for='radioRTavail_" + Ttotlen + "' id='lblGFare" + Ttotlen + "' onmousemove='CheckGrossFare(" + Ttotlen + ");' onmouseout='checkoutGrossFare(" + Ttotlen + ")'>" + Math.ceil(JSONdata["NETFare"]) + "</span></span>"
                            }
                            else if ($("#hdn_AvailFormat").val() == "RIYA") {
                                SAvail_build += "<span class='flt-rgt pr-10'><span class='" + CurrencyIcon + " flt-lft font-13 pr-5'></span><span class='price' style='white-space: nowrap; chck5' for='radioRTavail_" + Ttotlen + "' id='lblGFare" + Ttotlen + "' onmousemove='CheckGrossFare(" + Ttotlen + ");' onmouseout='checkoutGrossFare(" + Ttotlen + ")'>" + Math.ceil(JSONdata["GFare"]) + "</span></span>"
                            }
                            else if ($("#hdn_AvailFormat").val() == "NAT") {
                                ...
                                SAvail_build += "<span class='flt-rgt pr-10'><span class='" + CurrencyIcon + " flt-lft font-13 pr-5'></span><span class='price flt-rgt' style='white-space: nowrap; chck5' for='radioRTavail_" + Ttotlen + "' id='lblGFare" + Ttotlen + "' onmousemove='CheckGrossFare(" + Ttotlen + ");' onmouseout='checkoutGrossFare(" + Ttotlen + ")'>" + Math.ceil(JSONdata["NETFare"]) + "</span></span>"
                            }
                            else {
                                SAvail_build += "<span class='flt-rgt pr-10'><span class='" + CurrencyIcon + " flt-lft font-13 pr-5'></span><span class='price' style='white-space: nowrap; chck6' for='radioRTavail_" + Ttotlen + "' id='lblGFare" + Ttotlen + "' onmousemove='CheckGrossFare(" + Ttotlen + ");' onmouseout='checkoutGrossFare(" + Ttotlen + ")'>" + con_WTMFare + "</span></span>"
                            }

                            SAvail_build += " </div>"

                            SAvail_build += "<div class='flt-lft txt txt-al-rgt w-100 addons'>";
                            SAvail_build += "<ul class='p-0 m-0 flt-rgt txt-al-rgt w-100'>";
                            SAvail_build += "<li class='flt-rgt display-inblock'>";
                            SAvail_build += Refundabletype((JSONdata["Refund"] == "TRUE" ? "R" : (JSONdata["Refund"] == "FALSE" ? "N-R" : "")));
                            SAvail_build += "</li>";
                            if (JSONdata["Bagg"] != null && JSONdata["Bagg"] != "" && JSONdata["Bagg"] != "N/A") {
                                SAvail_build += "<li class='flt-rgt display-inblock'>";
                                SAvail_build += "<span class='Availbag'><span class='' data-toggle='tooltip' data-placement='top' title='Baggage: " + (uniqueBagg.length == 1 ? uniqueBagg[0] : JSONdata["Bagg"]) + "'><i class='fa fa-suitcase'></i></span></span>";//<img src='"+ '/' + $("#hdn_producttype").val() + "/"+ strImageUrl + "Bkg.png?V" + Versionflag + "' class='Availbkgimg' id='showbaggimg" + Ttotlen + "' /><span class='baggfontcolr' id='showbagg" + Ttotlen + "'>" + (uniqueBagg.length == 1 ? uniqueBagg[0] : JSONdata["Bagg"]) + "</span>
                                SAvail_build += "</li>";
                            }
                            SAvail_build += "</ul>";
                            SAvail_build += " </div>";
                        ...
                        if ($('#hdtxt_trip').val() == "O" || $('#hdtxt_trip').val() == "Y" || ($('#hdtxt_trip').val() == "M" && $('body').data('segtype') == "I")) {
                            ...
                            if (best == "TRUE") {
                                ...
                                SAvail_build += '<input class="tgl tgl-flip" id="radioRTavail_' + Ttotlen + '" name="nameradio' + JSONdata["bindside_6_arg"] + '" onclick=' + '"' + "javascript:GetRowIndexSelect_old('" + Ttotlen + "','" + doubletripifflg + "','" + JSONdata["bindside_6_arg"] + "')" + '"' + '  name="nameradio' + JSONdata["bindside_6_arg"] + '" onclick=' + '"' + "javascript:GetRowIndexSelect_old('" + Ttotlen + "','" + doubletripifflg + "','" + JSONdata["bindside_6_arg"] + "')" + '"' + ' type="radio" style="height:0px;"> <label class="tgl-btn" style="display:none!important;" data-tg-off="Select" data-tg-on="Selected" for="radioRTavail_' + Ttotlen + '"></label>';
                                SAvail_build += '</div>';
                            }
                        }
                    ...
                    else //***************** with Details Flight Binding ***********/
                    {
                        ...
                        //avail #div 1-S
                        SAvail_build += "<div class='row row0 row-mob-0 rtripres' style='padding-bottom: 5px;'>";
                        SAvail_build += "<div class='col-xs-3 col-lg-2 col-md-2 col-sm-2 col5 l-hight l-mob-hight' style='text-align: center;z-index: 1;'>"
                        ...
                        if (($('#hdtxt_trip').val() == "R" || $('#hdtxt_trip').val() == "M") && $('body').data('segtype') == "D" && $("#hdn_AppHosting").val() == "BSA")
                            SAvail_build += "<div class='TEST col-xs-9 col-sm-7 col15 col-mob-5 mobmrgbtn'>"
                        else
                            SAvail_build += "<div class='col-xs-6 col-sm-8 p-0'>"
                        ...
                        if ($('#hdtxt_trip').val() == "Y" && $("#hdn_rtsplflag").val() == "N") {
                            ...
                            var availabilitybind = layouttimebind(onward, stopscnt, $('#hdtxt_trip').val(), Ttotlen, nextarraival);
                            SAvail_build += "<div class='" + triptype_grp + " col5 pos-rel' style='border-right: 1px solid #f5f5f5;margin-bottom:30px;'>" + availabilitybind + "</div>"
                        ...
                        var availabilitybind = layouttimebind(onward, stopscnt, $('#hdtxt_trip').val(), Ttotlen, nextarraival,"Y");
                        ...
                        if (($('#hdtxt_trip').val() == "R" || $('#hdtxt_trip').val() == "M") && $('body').data('segtype') == "D" && $("#hdn_AppHosting").val() == "BSA")
                            ...
                            SAvail_build += " <div class='col-sm-2 col-xs-3 col-mob-5 farearea'>";
                        ...
                        //Fare Popup Added on 20170513 End...
                            ...
                            if ($("#HideComission").val() == "Y") {
                                SAvail_build += "<span class='flt-rgt pr-10'><span class='" + CurrencyIcon + " flt-lft font-13 pr-5'></span><span class='price' style='white-space: nowrap; chck1' id='lblGFare" + Ttotlen + "' onmousemove='CheckGrossFare(" + Ttotlen + ");' onmouseout='checkoutGrossFare(" + Ttotlen + ")'>" + Math.ceil(JSONdata["NETFare"]) + "</span></span>"
                            }
                            else if ($("#hdn_AvailFormat").val() == "RIYA") {
                                SAvail_build += "<span class='flt-rgt pr-10'><span class='" + CurrencyIcon + " flt-lft font-13 pr-5'></span><span class='price' style='white-space: nowrap; chck1' id='lblGFare" + Ttotlen + "' onmousemove='CheckGrossFare(" + Ttotlen + ");' onmouseout='checkoutGrossFare(" + Ttotlen + ")'>" + Math.ceil(JSONdata["GFare"]) + "</span></span>";
                            }
                            else if ($("#hdn_AvailFormat").val() == "NAT") {
                                if (JSONdata["com"].toString() != "0" && JSONdata["com"].toString() != "0.00") {
                                ...
                                SAvail_build += "<span class='flt-rgt pr-10'><span class='" + CurrencyIcon + " flt-lft font-13 pr-5'></span><span class='price' style='white-space: nowrap; chck2' id='lblGFare" + Ttotlen + "' onmousemove='CheckGrossFare(" + Ttotlen + ");' onmouseout='checkoutGrossFare(" + Ttotlen + ")'>" + con_WTMFare + "</span></span>";
                            }
                            SAvail_build += "</div>";
                            //static added need change dynamic
                            SAvail_build += "<div class='flt-lft txt txt-al-rgt w-100 addons'>";
                            SAvail_build += "<ul class='p-0 m-0 flt-rgt txt-al-rgt w-100'>";
                            SAvail_build += "<li class='flt-rgt display-inblock'>";
                            SAvail_build += Refundabletype((JSONdata["Refund"] == "TRUE" ? "R" : (JSONdata["Refund"] == "FALSE" ? "N-R" : "")));
                    ...
                    if ($('#hdtxt_trip').val() == "O" || $('#hdtxt_trip').val() == "Y" || ($('#hdtxt_trip').val() == "M")) {   // && $('body').data('segtype') == "I"
                        if (setofgroupedflight.length > 1) {
                            if (sr == 0) {
                                ...
                                SAvail_build += "<div class='commonclsgrp row row0 row-mob-0 dummymoreMAN" + gropfincon + "_flightno_" + con_Fno.split(' ')[1] + "' style='display:none!important;'>";

                                if ($("#hdn_AppHosting").val() == "B2B") {
                                    ...
                                    SAvail_build += "<div class='col-md-6 col-xs-12 float-right pad-rgt-5-res' style='text-align:right'>" + ClsFareType + "" + seatconu + "" + baggagedetails_grp + "" + Refundabletype(JSONdata["Refund"] == "TRUE" ? "R" : (JSONdata["Refund"] == "FALSE" ? "N-R" : "")) + "</div>";
                                    SAvail_build += "</div'>"
                                }
                                ...
                                if ($('#hdtxt_trip').val() == "M" && $('body').data('segtype') == "D") {
                                    if ($("#hdn_AppHosting").val() == "BSA") {
                                        SAvail_build += '<div class="b dummymore' + gropfincon + '_flightno_' + con_Fno.split(' ')[1] + ' col-lg-10  ssws col10" style="text-align: center;display:none;"><span class="dummymore' + gropfincon + "_flightno_" + con_Fno.split(' ')[1] + '  moreflightcss" style="padding:0px;"><span class="groupcntflicont_' + gropfincon + '_flightno_' + con_Fno.split(' ')[1] + '" ><span class="symbol_' + gropfincon + '_flightno_' + con_Fno.split(' ')[1] + '">+</span>' + totalfli + '</span><span onclick=' + '"' + "javascript:ToggleConnectGroup('" + gropfincon + "','" + con_Fno.split(' ')[1] + "')" + '"' + '> More fare(s)</span></span></div>'; //0612
                                    }
                                    else {
                                    ...
                                    if ($("#hdn_AppHosting").val() == "BSA") {
                                        SAvail_build += '<div class="b dummymore' + gropfincon + '_flightno_' + con_Fno.split(' ')[1] + ' col-lg-10  ssws col0 txt-rt" style="text-align: center;margin-top: -18px;display:none;"><span class="dummymore' + gropfincon + "_flightno_" + con_Fno.split(' ')[1] + '  moreflightcss" style="padding:0px;"><span class="groupcntflicont_' + gropfincon + '_flightno_' + con_Fno.split(' ')[1] + '" ><span class="symbol_' + gropfincon + '_flightno_' + con_Fno.split(' ')[1] + '">+</span>' + totalfli + '</span><span onclick=' + '"' + "javascript:ToggleConnectGroup('" + gropfincon + "','" + con_Fno.split(' ')[1] + "')" + '"' + '> More fare(s)</span></span></div>'; //0612
                                    }
                                    else {
                                        SAvail_build += '<div class="b dummymore' + gropfincon + '_flightno_' + con_Fno.split(' ')[1] + ' col-lg-10  ssws col0 txt-rt" style="text-align: center;margin-top: -3px;display:none;"><span class="dummymore' + gropfincon + "_flightno_" + con_Fno.split(' ')[1] + '  moreflightcss" style="padding:0px;"><span class="groupcntflicont_' + gropfincon + '_flightno_' + con_Fno.split(' ')[1] + '" ><span class="symbol_' + gropfincon + '_flightno_' + con_Fno.split(' ')[1] + '">+</span>' + totalfli + '</span><span onclick=' + '"' + "javascript:ToggleConnectGroup('" + gropfincon + "','" + con_Fno.split(' ')[1] + "')" + '"' + '> More fare(s) in same flight</span></span></div>'; //0612
                                    }
                                }
                            ...
                            if ($("#hdn_AppHosting").val() == "B2B") {
                                ...
                                SAvail_build += "<div class='col-md-6 col-xs-12 float-right pad-rgt-5-res mulpad-lr-10 mulpad-lr-5' style='text-align:right'>" + ClsFareType + "" + seatconu + "" + baggagedetails_grp + "" + Refundabletype(JSONdata["Refund"] == "TRUE" ? "R" : (JSONdata["Refund"] == "FALSE" ? "N-R" : "")) + "</div>";
                                SAvail_build += "</div>";
                            }
                    ...
                    if ($('#hdtxt_trip').val() == "R") {
                        ...
                        if (setofgroupedflight.length > 1) {
                            if (sr == 0) {
                                var totalfli = (setofgroupedflight.length) - 1;
                                SAvail_build += "<div class='hegcls commonclsgrp row row0 row-mob-0 dummymoreMAN" + gropfincon + "_flightno_" + con_Fno.split(' ')[1] + "'  style='display:none!important;'>";
                                if ($("#hdn_AppHosting").val() == "B2B") {
                                ...
                                // More Fare Available 
                                if ($("#hdn_AppHosting").val() == "BSA") {
                                    SAvail_build += '<div class="dummymore' + gropfincon + '_flightno_' + con_Fno.split(' ')[1] + ' txt-cntr" style="text-align: center;display:none;"><span class="dummymore' + gropfincon + "_flightno_" + con_Fno.split(' ')[1] + '  moreflightcss roundtripcls TES" ><span class="groupcntflicont_' + gropfincon + '_flightno_' + con_Fno.split(' ')[1] + '"><span class="symbol_' + gropfincon + '_flightno_' + con_Fno.split(' ')[1] + '">+</span>' + totalfli + '</span><span onclick=' + '"' + "javascript:ToggleConnectGroup('" + gropfincon + "','" + con_Fno.split(' ')[1] + "')" + '"' + '> More fare(s)</span></span></div>';
                                }
                                else {
...
function layouttimebind(layoutfiled, stopscnt, trip, Ttotlen, nextarraival,strReturnIcon) {
    //new layout binding section for mobile availability start
    var L_Build = "";

    var weekdays = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"];
    var FullWeekdays = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];

    var L_count = layoutfiled.length;
    var L_Origin = cityname(layoutfiled[0].Org);
    var L_Destionation = cityname(layoutfiled[L_count - 1].Des);
    var L_DepatureTime = layoutfiled[0].Dep.split(' ')[3];
    var L_ArrivalTime = layoutfiled[L_count - 1].Arr.split(' ')[3];
    var L_Duration = 0;
    var L_Stops = Number(layoutfiled[0].Stops);
    
    var D_date = moment(layoutfiled[0].Dep);
    var D_dow = D_date.day();
    
    var A_date = moment(layoutfiled[L_count - 1].Arr);
    var A_dow = A_date.day();

    var layouttime = CalcTimeDiff(layoutfiled[L_count - 1].Arr, layoutfiled[0].Dep);

    var D_weekday = $("#hdn_AppHosting").val() == "BSA" ? FullWeekdays[D_dow] : weekdays[D_dow];
    var A_weekday = $("#hdn_AppHosting").val() == "BSA" ? FullWeekdays[A_dow] : weekdays[A_dow];
    var deptooltip = $("#hdn_AppHosting").val() == "BSA" ? (D_weekday + ', ' + layoutfiled[0].Dep) : (layoutfiled[0].Dep + ', ' + D_weekday);
    var arrtooltip = $("#hdn_AppHosting").val() == "BSA" ? (A_weekday + ', ' + layoutfiled[L_count - 1].Arr) : (layoutfiled[L_count - 1].Arr + ', ' + A_weekday);

    for (var i = 0; i < L_count; i++) {
        L_Duration += Number(layoutfiled[i].Dur);
        L_Duration += Number(layoutfiled[i].fly);
    }
    if ($('#hdtxt_trip').val() == "O" || ($('#hdtxt_trip').val() != "O" && $('body').data('segtype') == "I")) {
        if (strReturnIcon != null && strReturnIcon != undefined && strReturnIcon == "Y") {
            L_Build += '<div class="pos-abs l--30 flight_dep"><img src="' + strImageUrl + '/' + $("#hdn_producttype").val() + '/flight_icon_2.png"/></div>';
        }
        else {
            L_Build += '<div class="pos-abs l--30 flight_arv"><img src="' + strImageUrl + '/' + $("#hdn_producttype").val() + '/flight_icon_1.png"/></div>';
        }
    }
    L_Build += '<div class="col-sm-2 col-xs-3 font-13 fnt-wt-600 fnt-wt dark clsavailTimes p-0" id="span_depature' + Ttotlen + '" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="DEP:' + deptooltip + '">' + L_DepatureTime + '</div>';

    L_Build += '<div class="bordecls 1 col-xs-6 col-sm-8 mt-10">';
    L_Build += '<span class="font-11 flt-lft w-100 pos-abs l-0 txt-center t--17" id="1" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Flying Time:' + layouttime + '">' + layouttime + '</span>';
    if (L_Stops > 0) {
        L_Build += '<span class="font-11 flt-lft w-100 pos-abs l-0 txt-center t-2" id="1" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="">'+L_Stops+' Stop</span>'; //hot
    }
    else {
        L_Build += '<span class="font-11 flt-lft w-100 pos-abs l-0 txt-center t-2" id="1" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="">Non - Stop</span>'; //hot
    }
    L_Build += '<span class="clsavailcityicon doticonlaycls" style="width: 12px;height: 12px;top: -7px !important;left:0px;"></span>'; //0602
    L_Build += '</div>';
    L_Build += '<div class="col-sm-2  col-xs-3 font-13 fnt-wt-600 p-0 dark clsavailTimes txt-al-rgt" id="span_Arrival' + Ttotlen + '" style="float: right;right: 0;" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Arr:' + arrtooltip + ' ">' + L_ArrivalTime + '</div>';
    L_Build += '<div class="bordecls 3" style="width:auto;float:left">';
    L_Build += '<span class="clsavailcityicon doticonlaycls mobdestdot" style="width: 12px;height: 12px;"></span>'; //0602
    L_Build += '<div class="finaltimecls" style="position: relative;width: 100%;">';
    L_Build += '</div>';
    L_Build += '</div>';

    return L_Build;
    //new layout binding section for mobile availability end
...
function Refundabletype(Faretype) {
    ...
    if (Faretype == "R")
        ...
        Ref_dt = "<i class='Faretype-NONRef' data-toggle='tooltip' data-placement='top' title='Non-Refundable' data-original-title='Non-Refundable'>N</i>";
    else if (Faretype == "C")
