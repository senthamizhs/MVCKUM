...
//------------------------------------------------------------------------------
    ...
    var LobiboxBase = {
        ...
        _createMarkup: function () {            
            ...
            var header = $('<div class="lobibox-header col-sm-2 float-left"></div>')
                .append('<span class="lobibox-title"></span>')
                //.append('<span class="lobibox-title">'+me._afterShow()+'</span>')
                ;
            var body = $('<div class="lobibox-body col-sm-10 float-left"></div>')
             
            lobibox.append(header);
            lobibox.append(body);
            if (me.$options.buttons && !$.isEmptyObject(me.$options.buttons)) {
                var footer = $('<div class="lobibox-footer col-sm-10 text-center float-left"></div>');
        ...
        _addCloseButton: function () {
            ...
            me.$el.find('.lobibox-body-text-wrapper').append(closeBtn);
...
//------------------------------------------------------------------------------
        ...
        setTitle: function (title) {
            ...
            //Sampel
            var d = $('<div></div>');
            if (title.$options.iconClass) {
                
              //  if (Themetype == "THEME-4") {
                    //var imgpath = title.$options.title == "Information" ? "../Img/Alertmsg/" + title.$options.title + ".png" : title.$options.title == "Success" ? "../Img/Alertmsg/" + title.$options.title + ".png" : title.$options.title == "Warning" ? "../Img/Alertmsg/" + title.$options.title + ".png" : title.$options.title == "Error" ? "../Img/Alertmsg/" + title.$options.title + ".png" :"Information" ? "../Img/Alertmsg/" + title.$options.title + ".png" : title.$options.title == "Alert" ? "../Img/Alertmsg/" + title.$options.title + ".png": confirmlobi;
              //  }
               // //else {
                    var imgpath = "../Images/" + title.$options.title + ".png"; //title.$options.title == "Information" ? "../Img/" + title.$options.title + ".png" : title.$options.title == "Success" ? "../Img/" + title.$options.title + ".png" : title.$options.title == "Warning" ? "../Img/" + title.$options.title + ".png" : title.$options.title == "Error" ? "../Img/" + title.$options.title + ".png" : confirmlobi;
                //}
                d.append($('<div class="lobibox-icon-wrapper"></div>')
                    //.append('<i class="lobibox-icon ' + title.$options.iconClass + '"></i>'))
                    .append('<img src="'+ imgpath + '" class="lobibox-icon ">'))
                ;
            }
            d.append('<div class="lobibox-body-text-wrappers"><span class="lobibox-body-text"></span></div>');
            title._setContent(d.html());
            title._position();
            LobiboxBase._afterShow.call(title);
            //$(".lobibox-header").addClass("lobibox-body");
            return this.$el.find('.lobibox-title').html(d.html());
        },
...
//            ALERT_OPTIONS = $.extend({}, LobiboxAlert.OPTIONS, Lobibox.alert.DEFAULTS);
        ...
        _afterShow: function () {
            ...
            if (me.$options.iconClass) {
                d.append($('<div class="lobibox-icon-wrapper"></div>')
                    .append('<i class="lobibox-icon "></i>'))//' + me.$options.iconClass + '
                ;
            }

            
            d.append('<div class="lobibox-body-text-wrapper"><span class="lobibox-body-text"><span class="_' + me.$options.title + '">' + me.$options.title + "</span></br>" + me.$options.msg + '</span></div>');
            me._setContent(d.html());
            me._position();
            if (me.$options.closeButton) {
                me._addCloseButton();
