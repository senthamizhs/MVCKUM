...
(function (factory) {
    ...
    var editable = renderer.create('<div class="note-editable panel-body" id="textareamail1" contentEditable="true"/>');
    ...
    var airEditable = renderer.create('<div class="note-editable" id="textareamail2" contentEditable="true"/>');
    ...
    var HelpDialog = function (context) {
        ...
        this.initialize = function () {
            ...
            //var body = [
            //  '<p class="text-center">',
            //  '<a href="//summernote.org/" target="_blank">Summernote 0.8.1</a> Â· ',
            ...
            this.$dialog = ui.dialog({
                ...
                footer: "<div style='height:25px;'></div>",//body,
                callback: function ($node) {
