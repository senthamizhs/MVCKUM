...
var ListView = /** @class */ (function (_super) {
    ...
    ListView.prototype.dayHeaderHtml = function (dayDate) {
        ...
        return '<tr class="fc-list-heading" data-date="' + dayDate.format('YYYY-MM-DD') + '">' +
          ...
          (altFormat ? this.buildGotoAnchorHtml(dayDate, { 'class': 'fc-list-heading-main' }, util_1.htmlEscape(dayDate.format(altFormat))) : '')
         // + (mainFormat ? this.buildGotoAnchorHtml(dayDate, { 'class': 'fc-list-heading-main' }, util_1.htmlEscape(dayDate.format(mainFormat)) ) :'') +
            '</td>' +
            '</tr>';
    };
    return ListView;
                ...
                $.each(buttonGroupStr.split(','), function (j, buttonName) {
                    ...
                    if (buttonName === 'title') {
                        ...
                        if (buttonClick) {
                            ...
                            var fullcalmonclickevenet = buttonInnerHtml == "month" ? "onclick=fullcalmonthclickent()" : buttonName == "next" ? "onclick=Nextmonthweekfn()" : buttonName == "prev" ? "onclick=Prevmonthweekfn()" : buttonInnerHtml == "today" ? "onclick=fullcaltodayevent()" : buttonInnerHtml == "week" ? "onclick=fullcalweekevent()" : ""; // by vijai 30072018
                            buttonEl = $(// type="button" so that it doesn't submit a form
                            '<button ' + fullcalmonclickevenet + ' type="button" class="' + buttonClasses.join(' ') + '"' +
                                buttonAriaAttr +
...
var ListEventRenderer = /** @class */ (function (_super) {
    ...
    ListEventRenderer.prototype.fgSegHtml = function (seg) {
        ...
        var createretvar = "";
            ...
            createretvar += '<tr class="' + classes.join(' ') + '">';
        createretvar += '<td class="fc-list-item-marker ' + theme.getClass('widgetContent') + '">';
        createretvar += '<span class="fc-event-dot "' + (bgColor ? ' style="background-color:' + bgColor + '"' : '') + '></span>' + '</td>';
        createretvar += '<td class="fc-list-item-title ' + theme.getClass('widgetContent') + '">';
        createretvar += '<a>' + util_1.htmlEscape(eventDef.title || '') + '</a>' + '</td>';
            createretvar += '</tr>';
        
        usedefinedprevday = eventDef.id;
        return createretvar
        ...
        //    //'<span class="fc-event-dot"' +  (bgColor ? ' style="background-color:' + bgColor + '"' : '') + '></span>' + '</td>' +
        //    //'<td class="fc-list-item-title ' + theme.getClass('widgetContent') + '">' +
        //    //'<a>'+ util_1.htmlEscape(eventDef.title || '') +  '</a>' + '</td>' +
        //    '</tr>';
